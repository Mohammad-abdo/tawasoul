import * as addressRepo from '../../repositories/user/address.repository.js';
...
export const getUserAddresses = async (userId) => {
  const addresses = await addressRepo.findAllByUserId(userId);
  return {
...
export const createAddress = async (userId, data) => {
  ...
  if (isDefault) {
    await addressRepo.setDefaultForUser(userId, address.id);
...
export const updateAddress = async (userId, id, data) => {
  ...
  if (isDefault) {
    await addressRepo.setDefaultForUser(userId, id);
  }
